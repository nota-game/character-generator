<script lang="ts">
	...
	import { getText, getTextTalent, renderRequirementMap } from 'src/misc/misc';
	...
	export let selectedFilter: 'support or purchased' | 'purchased' | 'all';
...
<!-- <div class="root"> -->
{#if selectedFilter == 'all' || (selectedFilter == 'support or purchased' && ($purchased > 0 || $fixed > 0|| $support > 0)) || (selectedFilter == 'purchased' && ($purchased > 0 || $fixed > 0))}
	<tr>
		<td>
